...
const ScheduledNotifications = ({ styles }) => {

    const { PaginatorTemplate, pageNumber } = usePaginator()

    // Get Scheduled Notifications
    const { data, isLoading, error } = useFetch(`${process.env.REACT_APP_BACKEND_API_URL}/api/v1/admin/cp/administrators/push-notification/fetch/?page=${pageNumber}&scheduled=true`)
