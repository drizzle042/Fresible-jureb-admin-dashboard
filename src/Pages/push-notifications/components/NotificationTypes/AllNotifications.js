...
const AllNotifications = ({ styles, allData }) => {

    const { PaginatorTemplate, pageNumber } = usePaginator()

    // Get All Notifications
    const { data, setData, isLoading, error } = useFetch(`${process.env.REACT_APP_BACKEND_API_URL}/api/v1/admin/cp/administrators/push-notification/fetch/?page=${pageNumber}`)
